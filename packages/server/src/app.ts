...
import servicesCatalogRoutes from './routes/services-catalog';
...
app.route('/api/recent-activity', recentActivityRoutes);
app.route('/api/services-catalog', servicesCatalogRoutes);
